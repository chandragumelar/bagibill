...
- `packages/tokens/`: token visual, generated dari Codex Design. Nol edit tangan.
...
- `.agents/skills/bagibill-qa/SKILL.md`: prosedur QA. Jalankan sebelum bilang sesuatu selesai.
...
- **Aturan baru yang berlaku untuk semua tugas berikutnya** masuk `AGENTS.md` sebagai satu baris, alasannya di Keputusan di `progress.md`. Kalau baris di sini mulai berisi penjelasan panjang, penjelasannya salah tempat.
- **Cara baru untuk salah menghitung uang atau merusak layar** masuk `.agents/skills/bagibill-qa/SKILL.md` sebagai butir yang bisa dicek. Setiap bug yang lolos sekali harusnya meninggalkan satu baris di sana supaya tidak lolos dua kali.
