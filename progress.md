...
Status terakhir diperbarui: 20 Agustus 2026
Fase aktif: F3 mulai. F1 (split engine) dan F2 (storage) tutup seluruhnya (F1-01 sampai F1-10, F2-01 sampai F2-05). F0-01 sampai F0-04 dan F0-08 selesai; F0-05 sampai F0-07 kodenya selesai, menunggu uji HP fisik. F3-01 (tambah pengeluaran mode Rata) kodenya selesai, menunggu uji HP fisik. Seluruh mockup gelombang 1 selesai.
