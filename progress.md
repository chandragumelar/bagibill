...
Fase aktif: F2 (storage). F1 (split engine) tutup seluruhnya (F1-01 sampai F1-10). F2-01 selesai. F0-01 sampai F0-04 dan F0-08 selesai; F0-05 sampai F0-07 kodenya selesai, menunggu uji HP fisik. Seluruh mockup gelombang 1 selesai.
